page 50124 "Cash Advance Payment"
{
        ...
        area(navigation)
        {
            ...
            group("&Payments")
            {
                ...
                action("Print WHT Certificate")
                {
                    ...
                    trigger OnAction()
                    begin
                        //WHTManagement.PreprintingWHT(Rec);//VAH
                    end;
                }
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(CancelPostDatedCheck)
                {
                    ...
                    trigger OnAction()
                    begin
                        //PostDatedCheckMgt.CancelCheck(Rec);//VAH
                    end;
                }
    ...
    begin
        ...
        "Account Type" := "Account Type"::Vendor;//vah
    end;
    ...
    begin
        ...
        GenJnlManagement.TemplateSelection(PAGE::"Cash Advance Payment", "Gen. Journal Template Type"::"Cash Advance", false, Rec, JnlSelected);
