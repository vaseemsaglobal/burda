page 50127 "Back Charge Journal"
{
            ...
            group(Control120)
            {
                ...
                field("<CurrentCurrencyCode>"; CurrentCurrencyCode)
                {
                    ...
                    begin
                        ...
                        CheckCurrencyCode(CurrentCurrencyCode);//SAG
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(Post)
                {
                    ...
                    trigger OnAction()
                    begin
                        //CheckAdjustmentAppliesto;//SAG
                        CheckAdjustmentAppliestoCopy;//SAG
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(false, PAGE::"Back Charge Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"Back Charge Journal", CurrentJnlBatchName);
                        PAGE.Run(PAGE::"Back Charge Journal");
                    end;
                }
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(true, PAGE::"Back Charge Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"Back Charge Journal", CurrentJnlBatchName);
                        PAGE.Run(PAGE::"Back Charge Journal");
                    end;
                }
    ...
    begin
        ...
        then
            ...
            IsSimplePage := GenJnlManagement.GetJournalSimplePageModePreference(PAGE::"Back Charge Journal");
    ...
    begin
        ...
        GenJnlManagement.TemplateSelection(PAGE::"Back Charge Journal", "Gen. Journal Template Type"::"BC General", false, Rec, JnlSelected);//VAH
        if not JnlSelected then
            Error('');

        LastGenJnlBatch := GenJnlManagement.GetLastViewedJournalBatchName(PAGE::"Back Charge Journal");
    ...
    //<<SAG
    //>>SAG
    procedure CheckAdjustmentAppliestoCopy()
    var
        SourceCodeSetup: Record "Source Code Setup";
        GenJournalLine2: Record "Gen. Journal Line";
        Text50000: Label 'You have not selected the Adjustment Applies-to, Do you still want to continue with the Document.';
        GLSetup: Record "General Ledger Setup";
        Text50001: Label 'The posting has been interrupted to respect the warning.';
    begin
        //ReadGLSetupCopy();
        GLSetup.get;
        SourceCodeSetup.Get();
