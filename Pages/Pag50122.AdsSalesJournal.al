page 50122 "Ads. Sales Journal"
{
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(false, PAGE::"Ads. Sales Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"Ads. Sales Journal", CurrentJnlBatchName);
                ...
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(true, PAGE::"Ads. Sales Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"Ads. Sales Journal", CurrentJnlBatchName);
                        PAGE.Run(PAGE::"Ads. Sales Journal");
                    end;
                }
    ...
    begin
        ...
        then
            ...
            IsSimplePage := GenJnlManagement.GetJournalSimplePageModePreference(PAGE::"Ads. Sales Journal");
    ...
    begin
        ...
        GenJnlManagement.TemplateSelection(PAGE::"Ads. Sales Journal", "Gen. Journal Template Type"::"Ads. Sales", false, Rec, JnlSelected);//VAH
        if not JnlSelected then
            Error('');

        LastGenJnlBatch := GenJnlManagement.GetLastViewedJournalBatchName(PAGE::"Ads. Sales Journal");
