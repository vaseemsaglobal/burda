report 50176 "SalesCreditNote"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/50176_SalesCreditNote.rdl';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Billtocontact; "Sales Cr.Memo Header"."External Document No.")
                    {
                    }
                    ...
                    column(PostingDt_SalesInvHeader; Format("Sales Cr.Memo Header"."Posting Date", 0, 4))
                    {
                    }
                    ...
                    column(ProductAdsInvoice; '')
                    //"Sales Cr.Memo Header"."Product (Ads. Invoice)")
                    {
                    }
                    column(Reamrk1; "Sales Cr.Memo Header"."Remark 1")
                    {
                    }
                    column(Reamrk2; Remark2)
                    //"Sales Cr.Memo Header"."Remark 2")
                    {
                    }
                    column(Attn; "Sales Cr.Memo Header"."Sell-to Contact")
                    {
                    }
                    column(PoNO; '')
                    //"Sales Cr.Memo Header"."PO No.")
                    {
                    }
            ...
            begin
                ...
                if CommentText = '' then
                    Remark2 := "Sales Cr.Memo Header"."Remark 2"
                else
                    Remark2 := CommentText;
            end;
    ...
    begin
        ...
        LanguageCaption.SetRange("Report ID", 50176);
