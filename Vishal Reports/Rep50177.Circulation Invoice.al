report 50177 "Circulation Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/50177_Circulation Invoice.rdl';
    Caption = 'Circulation Invoice';
    ...
    begin
        ...
        LanguageCaption.SetRange("Report ID", 50171);
