report 50170 "Receipt & Tax Inv (TH)"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/50170_ReceiptTaxInv(TH).rdl';
    Caption = 'Receipt & Tax Inv (TH)';
    ...
    dataset
    {
        dataitem("Sales Tax Invoice/Rec. Header"; "Sales Tax Invoice/Rec. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Billtocontact; "Sales Tax Invoice/Rec. Header"."Order No.") //"Bill-to Contact No."
                    {
                    }
                    column(SelltoCustomerName; "Sales Tax Invoice/Rec. Header"."Sell-to Customer Name")
                    {
                    }
                    ...
                    column(BilltoCustNo_SalesInvHeader; "Sales Tax Invoice/Rec. Header"."Bill-to Customer No.")
                    {
                    }
                    column(PostingDt_SalesInvHeader; Format("Sales Tax Invoice/Rec. Header"."Posting Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegsNo_SalesInvHeader; "Sales Tax Invoice/Rec. Header"."VAT Registration No.")
                    {
                    }
                    column(DueDate_SalesInvHeader; Format("Sales Tax Invoice/Rec. Header"."Due Date", 0, 4))
                    {
                    }
                    ...
                    column(SalesInvHeaderNo1; "Sales Tax Invoice/Rec. Header"."Issued Tax Invoice/Receipt No.")
                    {
                    }
                    column(ExternalDocno; "Sales Tax Invoice/Rec. Header"."External Document No.")
                    {
                    }
                    column(ReferenceText; ReferenceText)
                    {
                    }
                    column(SalesInvHeaderYourReference; "Sales Tax Invoice/Rec. Header"."Your Reference")
                    {
                    }
                    column(OrderNoText; OrderNoText)
                    {
                    }
                    column(OrderNo_SalesInvHdr; "Sales Tax Invoice/Rec. Header"."Order No.")
                    {
                    }
                    ...
                    column(DocumentDate04_SalesInvHeader; Format("Sales Tax Invoice/Rec. Header"."Order Date", 0, 4))
                    {
                    }
                    column(PricesIncludVAT_SalesInvHdr; "Sales Tax Invoice/Rec. Header"."Prices Including VAT")
                    {
                    }
                    column(OutputNo; OutputNo)
                    {
                    }
                    column(PricesInclVATYesNo; Format("Sales Tax Invoice/Rec. Header"."Prices Including VAT"))
                    {
                    }
                    ...
                    column(BilltoCustNo_SalesInvHeaderCaption; "Sales Tax Invoice/Rec. Header".FieldCaption("Bill-to Customer No."))
                    {
                    }
                    column(PricesIncludVAT_SalesInvHdrCaption; "Sales Tax Invoice/Rec. Header".FieldCaption("Prices Including VAT"))
                    {
                    }
                    ...
                    column(ProductAdsInvoice; "Sales Tax Invoice/Rec. Header".Brand)
                    {
                    }
                    column(Reamrk1; '')
                    //"Sales Tax Invoice/Rec. Header"."Remark 1")
                    {
                    }
                    column(Reamrk2; '')
                    //"Sales Tax Invoice/Rec. Header"."Remark 2")
                    {
                    }
                    column(Attn; "Sales Tax Invoice/Rec. Header"."Bill-to Contact")
                    {
                    }
                    column(PoNO; '')
                    // "Sales Tax Invoice/Rec. Header"."PO No.")
                    {
                    }
                    ...
                    column(PaidByLbl; PaidByLbl)
                    {
                    }
                    column(CashLbl; CashLbl)
                    {
                    }
                    column(ChequeByBankLbl; ChequeByBankLbl)
                    {
                    }
                    column(BranchPaidLbl; BranchPaidLbl)
                    {
                    }
                    column(ChequeNoLbl; ChequeNoLbl)
                    {
                    }
                    column(TransferLbl; TransferLbl)
                    {
                    }
                    column(ReceivedBylebal; ReceivedBylebal)
                    {
                    }
                    column(ReceivedtheLbl; ReceivedtheLbl)
                    {
                    }
                    column(ReceivedDateLbl; ReceivedDateLbl)
                    {
                    }
                    column(Datelbl; Datelbl)
                    {
                    }
                    dataitem("Sales Tax Invoice/Rec. Line"; "Sales Tax Invoice/Rec. Line")
                    {
                        ...
                        column(Desc_SalesInvLine; "Posted Document No." + ' ' + Description)
                        {
                        }
                        ...
                        {
                            AutoFormatExpression = "Sales Tax Invoice/Rec. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATBaseDisc_SalesInvHdr; "Sales Tax Invoice/Rec. Header"."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        column(SalesInvHeaderCurrFactor; "Sales Tax Invoice/Rec. Header"."Currency Factor")
                        {
                        }
                        ...
                        {
                            AutoFormatExpression = "Sales Tax Invoice/Rec. Line".GetCurrencyCode();
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            CalcVATAmountLineLCY("Sales Tax Invoice/Rec. Header", VATAmountLine, TempVATAmountLineLCY, VATBaseRemainderAfterRoundingLCY, AmtInclVATRemainderAfterRoundingLCY);
                ...
                trigger OnAfterGetRecord()
                var
                    salesinvoiceLine: Record "Sales Tax Invoice/Rec. Line";
                begin
                    ...
                    if PrintSummary then begin
                        ...
                        salesinvoiceLine.SetRange("Document No.", "Sales Tax Invoice/Rec. Header"."No.");
                    ...
                    if "Sales Tax Invoice/Rec. Header"."Currency Code" = '' then begin
                        currencyCode := GLSetup."Local Currency Symbol";
                        currencyDesc := GLSetup."Local Currency Description"
                    end
                    else begin
                        currencyCode := "Sales Tax Invoice/Rec. Header"."Currency Code";
                    ...
                    IF NOT CurrReport.PREVIEW THEN BEGIN
                        IF SalesTaxInvHeader.GET("Sales Tax Invoice/Rec. Header"."No.") THEN BEGIN
                            ...
                            IF NOT SalesTaxInvHeader."Issued Tax Invoice/Receipt" THEN BEGIN
                                ...
                                "Sales Tax Invoice/Rec. Header"."Issued Tax Invoice/Receipt No." := NoSeriesMgt.GetNextNo(SalesSetup."Issued Tax Invoice/Receipt Nos", WORKDATE, TRUE);
                                SalesTaxInvHeader."Issued Tax Invoice/Receipt No." := "Sales Tax Invoice/Rec. Header"."Issued Tax Invoice/Receipt No.";
                ...
                // begin
                //     if not IsReportInPreviewMode then CODEUNIT.Run(CODEUNIT::"Sales Inv.-Printed", "Sales Tax Invoice/Rec. Header");
                // end;
                trigger OnPreDataItem()
                begin
            ...
            begin
                ...
                IF NOT SalesTaxInvLine.FIND('-') THEN ERROR('There is no data on sales line.');
                ...
                //VR
                FormatAddressFields("Sales Tax Invoice/Rec. Header");
                FormatDocumentFields("Sales Tax Invoice/Rec. Header");
                ...
                //end;
                if "WHT Business Posting Group" IN ['WHT3', 'WHT53'] then SubjectText := 'WITHHOLDING TAX 2% or 3% ADVERTISING SALE';
            end;
    ...
    var
        ...
        PaidByLbl: Label 'Paid By';
        ChequesLbl: Label 'Cheques should be crossed "A/C PAYEE ONLY" and made payable to "%1". This receipt will be valid if payment by cheque is collected through the bank.';
        CashLbl: Label '□ Cash';
        ChequeByBankLbl: Label '□ Cheque by Bank _____________ Branch ___________________';
        BranchPaidLbl: Label 'Branch';
        ChequeNoLbl: Label '   Cheque No.___________________ Date ___________________';
        TransferLbl: Label '□ Transfer';
        ReceivedBylebal: Label 'Received By: _________________';
        ReceivedDateLbl: Label 'Received Date: ________________';
        Datelbl: Label 'Date';
        PreparedBylbl: Label 'Prepared By: _______________';
        AuthorizedSignatureLbl: Label 'Authorized Signature';
        ReceivedtheLbl: Label 'Received the above goods in good order and condition';
        ForLbl: Label 'For %1';
    ...
    local procedure FormatDocumentFields(SalesInvoiceHeader: Record "Sales Tax Invoice/Rec. Header")
    begin
    ...
    local procedure FormatAddressFields(SalesInvoiceHeader: Record "Sales Tax Invoice/Rec. Header")
    begin
    ...
    local procedure CalcVATAmountLineLCY(SalesInvoiceHeader: Record "Sales Tax Invoice/Rec. Header";
    ...
    begin
        ...
        LanguageCaption.SetRange("Report ID", 50170);
